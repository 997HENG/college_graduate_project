...
class CreateTestPage extends StatefulWidget {
  ...
  const CreateTestPage({super.key, required this.groupId});
  @override
...
class _CreateTestPageState extends State<CreateTestPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('創建測驗')),
      body: BlocListener<ExamBloc, ExamState>(
        listener: (context, state) {
          if (state is ExamCreateSuccess) {
            ScaffoldMessenger.of(context)
                .showSnackBar(const SnackBar(content: Text('測驗創建成功')));
