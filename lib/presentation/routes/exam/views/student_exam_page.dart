...
import 'package:tutor_app/presentation/routes/exam/views/exam_detail.dart';

class StudentExamPage extends StatefulWidget {
  final String groupId;
  const StudentExamPage({super.key, required this.groupId});
...
class _StudentExamPageState extends State<StudentExamPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 頁面初始化時加載已發布測驗
    return Scaffold(
      appBar: AppBar(title: const Text('可用測驗')),
